      ...
      try {
        ...
        if (courseDoc.exists()) {
          ...
          studentsData.sort((a, b) => {
            const aDate =
              a.enrolledAt?.toDate?.() || new Date(a.enrolledAt || 0);
            const bDate =
              b.enrolledAt?.toDate?.() || new Date(b.enrolledAt || 0);
            return bDate - aDate;
          });
      ...
      >
        ...
        >
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              {
                students.filter((s) => s.progress?.completionPercentage === 100)
                  .length
              }
            </div>
            ...
            >
              {
                students.filter(
                  (s) =>
                    (s.progress?.completionPercentage || 0) > 0 &&
                    (s.progress?.completionPercentage || 0) < 100,
                ).length
              }
            </div>
          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              {
                students.filter(
                  (s) => (s.progress?.completionPercentage || 0) === 0,
                ).length
              }
            </div>
                        ...
                        <div>
                          ...
                          <div style={{ fontSize: "14px", lineHeight: "1.6" }}>
                            ...
                            <div>
                              ...
                              {(progress.currentModule || 0) + 1}
                            </div>
                            <div>
                              <strong>Current Lesson:</strong>{" "}
                              {(progress.currentLesson || 0) + 1}
                            </div>
