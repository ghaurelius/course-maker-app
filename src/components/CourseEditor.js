  ...
  const deleteLesson = (moduleIndex, lessonIndex) => {
    if (window.confirm('Are you sure you want to delete this lesson?')) {
      ...
      if (selectedLesson >= updatedModules[moduleIndex].lessons.length) {
        setSelectedLesson(Math.max(0, updatedModules[moduleIndex].lessons.length - 1));
      }
    }
  };
    ...
    <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ 
        ...
        <div>
          ...
          <p style={{ margin: 0, color: '#666' }}>Modify your course content and structure</p>
        </div>
      ...
      {activeTab === 'content' && (
        <div style={{ display: 'flex', gap: '20px', height: '600px' }}>
            ...
            {modules.map((module, moduleIndex) => (
              <div key={moduleIndex} style={{ marginBottom: '15px' }}>
                <div style={{
                  ...
                  justifyContent: 'space-between',
                  padding: '8px',
                  backgroundColor: selectedModule === moduleIndex ? '#007bff' : '#e9ecef',
                  ...
                  <button
                    ...
                    style={{
                      background: 'none',
                      border: 'none',
                      color: selectedModule === moduleIndex ? 'white' : '#dc3545',
                      cursor: 'pointer',
                      fontSize: '12px'
                    }}
                  >
                    ...
                    {module.lessons && module.lessons.map((lesson, lessonIndex) => (
                      <div
                        ...
                        style={{
                          ...
                          justifyContent: 'space-between',
                          padding: '5px 8px',
                          backgroundColor: selectedLesson === lessonIndex ? '#6c757d' : '#fff',
                          color: selectedLesson === lessonIndex ? 'white' : '#333',
                          borderRadius: '3px',
                          marginBottom: '3px',
                          cursor: 'pointer',
                          fontSize: '13px'
                      ...
                      >
                        ...
                        <button
                          ...
                          style={{
                            background: 'none',
                            border: 'none',
                            color: selectedLesson === lessonIndex ? 'white' : '#dc3545',
                            cursor: 'pointer',
                            fontSize: '10px'
                          }}
                        >
          ...
          {/* Main Editor */}
          <div style={{ flex: 1, backgroundColor: '#fff', padding: '20px', borderRadius: '8px', border: '1px solid #ddd' }}>
            {modules.length === 0 ? (
              ...
              <div>
                ...
                {/* Lesson Editor */}
                {modules[selectedModule]?.lessons && modules[selectedModule].lessons.length > 0 && (
                  <div>
                    <div style={{ marginBottom: '15px' }}>
                      <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Lesson Title</label>
                      <input
                        type="text"
                        value={modules[selectedModule].lessons[selectedLesson]?.title || ''}
                    ...
                    <div>
                      <label style={{ display: 'block', marginBottom: '5px', fontWeight: 'bold' }}>Lesson Content</label>
                      <textarea
                        value={modules[selectedModule].lessons[selectedLesson]?.content || ''}
