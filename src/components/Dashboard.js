  ...
  return (
    <div style={{ padding: '20px' }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '30px' }}>
        ...
        <div>
          <span style={{ marginRight: '15px' }}>Welcome, {currentUser?.email}!</span>
          <button 
      ...
      <div style={{
        ...
        >
          ...
          <h3 style={{ color: '#17a2b8', margin: '0 0 10px 0' }}>My Learning</h3>
        ...
        >
          <div style={{ fontSize: '48px', marginBottom: '15px' }}>🌟</div>
          <h3 style={{ color: '#28a745', margin: '0 0 10px 0' }}>Discover Courses</h3>
          <p style={{ color: '#666', margin: '0', fontSize: '14px' }}>
